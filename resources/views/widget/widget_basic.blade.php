  ...
  <div class="row">
    ...
    <div class="col-xl-4 col-lg-12">
      <div class="card border-0 pb-0">
        ...
        <div class="card-body"> 
          <div id="DZ_W_Todo2" class="widget-media dz-scroll" style="height:370px;">
            <ul class="timeline">
              <li>
                <div class="timeline-panel">
                  <div class="media mr-2">
    ...
    <div class="col-xl-4 col-lg-12">
      <div class="card border-0 pb-0">
        ...
        <div class="card-body"> 
          <div id="DZ_W_Todo3" class="widget-media dz-scroll" style="height:370px;">
            <ul class="timeline">
              <li>
                <div class="timeline-panel">
                  <div class="media mr-2">
    ...
    <div class="col-xl-4 col-lg-12">
      <div class="card border-0 pb-0">
        ...
        <div class="card-body"> 
          <div id="DZ_W_Todo4" class="widget-media dz-scroll" style="height:370px;">
            <ul class="timeline">
              <li>
                <div class="timeline-panel">
      ...
      <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-xxl-6 col-md-6">
          <div class="card">
            ...
            <div class="card-body text-center">
              <div class="ico-sparkline">
                <div id="sparkline9" style="height:80px;"></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto">
              <div class="chart-wrapper" style="height: 100px">
                <canvas id="chart_widget_7" style="min-width:300px;"></canvas>
              </div>
            </div>
          </div>
        </div>
